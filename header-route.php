		...
		if ( $us_layout->header_show != 'never' ) {
			...
			<div id="webmapp-layer-container" class="webmapp-container">
				...
				<div id='webmapp-layer-2' class="webmapp-featured-meta">
					<div class="webmapp-featured-meta-info" style="background-image: url('/wp-content/themes/wm-child-verdenatura/images/background_menu_route_verde.png')">
						<div class="container">
							<!-- <div class="meta-bar price-from"> -->
								<div class="prezzo-container"> <!-- prezzo start-->
									<!-- <span class=""><?php //echo __('From', 'wm-child-verdenatura'); ?></span> -->
									<div class="prezzo">
							...
							<!-- </div> -->
							<!-- <div class="meta-bar show-prices"><?php //echo do_shortcode('[us_popup title="vedi i prezzi" btn_label="vedi i prezzi" popup_width="1000px" popup_padding="2%" btn_icon="fas|angle-down" title_textcolor="" content_bgcolor="#ffffff" content_textcolor="#333333" el_class="popup-show-prices" overlay_bgcolor="rgba(35,35,35,0.8)" title_bgcolor="#ffffff"][route_table_price][/us_popup]'); ?></div> -->

							<div class="meta-bar show-prices"><div id="popup-show-prices" class="popup-show-prices"><div class="w-btn-wrapper"><span class=""><i class="fas fa-angle-down"></i><span class="w-btn-label">vedi i prezzi</span></span></div></div></div>
							...
							<div id="wm-book" class="meta-bar wm-book"><p class='meta-bar-txt-bold'><?php echo __('Book now','wm-child-verdenatura');?></p></div>
						</div>
					</div>
					<div id="fixed-ancor-section" class="webmapp-fixed-ancor"> <!--- first section -->
					...
					<div id="cy-prices-modal" class="cy-prices-modal">
						<div class="cy-modal-content">
							<div class="cy-modal-header">
								...
								<div class="meta-bar wm-book"><p class="meta-bar-txt-bold"><?php echo __('Book now','wm-child-verdenatura');?></p></div>
							</div>
