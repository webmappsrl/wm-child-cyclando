...
<div id="main-content">
        ...
        if ( $tax )
        {
           ...
           ?>
            ...
            <!-- LAYER 1 -->
            <div id='webmapp-layer-1' class="webmapp-featured-image archive-taxonomy-featured-image">
    ...
    <div class="container archive-taxonomy">
        ...
        if ( $tax )
        {
            ...
            if ( $terms && ! is_wp_error( $terms ) )
            {
                ...
                foreach ( $terms as $term )
                {
                    ...
                    echo do_shortcode("[webmapp_anypost posts_per_page='3' template='cy_route' rows='1' posts_count='3' post_type='$attr_post_type' term_id='$term->term_id' main_tax='$term->taxonomy']");
                }
