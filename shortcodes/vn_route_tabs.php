    ...
    <div id="tabs-4">
                ...
                <?php
                    ...
                    <?php // ---------- single departures ----------------//
                        ...
                        <div class="single-departure">
                                <p class="tab-section"><?php if (have_rows('departure_dates')) { echo __('Extra departures' ,'wm-child-verdenatura'); } else{ echo __('Departures' ,'wm-child-verdenatura');}?></p>
                                <p class="part-e-pre"></p>
                        </div>
        ...
        <div id="tab-stagioni" class="container-stagionalita"> <!-- Start TAB Stagionalita -->
            <ul> 
                ...
                ?>
                <li><a href="#tab-<?php echo $season_name_id; ?>" style="border-right: solid 2px #0F7A68;"><?php
