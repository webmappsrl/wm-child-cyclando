...
?>
    ...
    <div id="main-content">
        ...
        ?>
            ...
            <!-- LAYER 2 -->
            <div id='webmapp-layer-2' class="webmapp-featured-image">
    ...
    <div class="container">
        <div id="content-area" class="clearfix">
                    ...
                    if ( $term && $term instanceof WP_Term  )
                    {
                        ...
                        echo do_shortcode("[webmapp_anypost template='cy_route' posts_per_page='9' rows='3' post_type='$attr_post_type' term_id='$term->term_id']");
