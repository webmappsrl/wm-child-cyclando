    ...
    while (have_posts()) {
                            ...
                            jQuery(document).ready(function() {
                                hbspt.forms.create({
                                    ...
                                    onFormReady: function($form, ctx) {
                                        ...
                                        window['hs-form-iframe-0'].contentDocument.querySelector('input[name="website"]').setAttribute('value', window.location.href)
                                    },
        ...
        <script>
                ...
                jQuery.ajax({
                    ...
                    complete: function(response) {
                        ...
                        setTimeout(() => {
                            ...
                            if (obj.depositaddtocart != undefined) {
            ...
            function updateYourReservationSummaryTxt(savedCookie) {
                ...
                if (savedCookie[post_id] != undefined && savedCookie[post_id]['extra']['single_room_paid']) {
