...
<?php echo "<a href='$title_link' title=\"" . get_the_title() . "\">"; ?>
    <div class="single-post-wm">
        ...
        <div class="title-holder">
            ...
            <figure class="webmapp_post_image" style="background-image: url('<?php echo $get_the_post_thumbanil; ?>')"> <div class="webmapp_post_meta">
            ...
            <div class="post_meta_info">
                ...
                <?php } else { ?>
                    <?php if ($days==1) { ?>
                        ...
                        <div class="route_first_date"><span class="route_duration_free"><?php echo $days . ' ' . 'giorno' ?></span></div>
                    
                    <?php } else { ?>
                        <div class="route_first_date"><span class="route_duration_free"><?php echo (!empty($duration))?$days . ' ' . __('days', 'wm-child-cyclando'):'' ?></span></div>
                <?php } ?>
                    <?php } ?>
            ...
            if (!$coming_soon) {
                ...
                <?php } elseif (return_route_targets_has_cyclando($post_id)) {?>
                    <a class="download-app-link" target="_blank" href="https://info.test.cyclando.com/app">
                        <div class="scarica-app">
                            <span class='meta-bar-txt-light'><?php echo __('Download', 'wm-child-cyclando'); ?><span class="lapp"><br>L'APP</span></span>
                        </div>
                    </a>
                <?php } else {?>
